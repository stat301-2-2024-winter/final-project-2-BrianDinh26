...
head(cars, n = 5) |> 
  DT::datatable()
```
The used car dataset has 40 variables. Specifically, there are 10 factor variables, 7 numerical variables, and 13 logical variables. There are 38,531 observations.
