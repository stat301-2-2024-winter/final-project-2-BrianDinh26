...
I chose to explore the training data to see if there were any relationships between variables that would be important to note when building the recipe for the model that can affect performance.
