...
bt_select_1 |> 
  knitr::kable()
```
According to @tbl-bt-hyper, the best hyperparameters for the boosted tree model with the kitchen sink recipe are 9 for the number of randomly drawn candidate variables, 5 for the minimum number of variables before a split, and a learn rate of approximately 0.0398107.
